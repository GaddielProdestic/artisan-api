...
trait  UserObjectTrait
{
     ...
     * @Groups({"trustee","syndic","city","rdv","activity","agency", "house", "terminate", "equipment", "contract", "inventory", "country", "admin", "user", "customer", "mutate","repayment",
     ...
     *     "tva", "account", "log", "logNature", "planModel", "accountingSetting", "defaultAccount", "trustee", "default", "house_co", "home_co", "optionS", "operation", "invoiceP", "funds-apeal", "houseco-lot", "homeco-lot","loadT","reservation"})
     */
    private $uuid;
     ...
     *      "subscription", "funding", "terminateF", "OptionF", "OptionR", "invoiceR", "paymentR", "bill", "path", "signed-file", "terminateM", "transaction", "mailSms", "disburs", "worksite", "building", "recommandation", "short-contract", "extend-contract","agent","offre"})
     */
     ...
     *     "terminateF", "OptionF", "OptionR", "invoiceR", "paymentR", "bill", "path", "signed-file", "terminateM", "transaction", "mailSms", "disburs", "worksite", "building", "recommandation", "short-contract", "extend-contract","agent","offre"})
     */
